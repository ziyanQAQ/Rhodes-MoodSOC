...
| `FACILITY_CONSUME` | 同设施全体消耗增减（含自身） | 全体求和 | 黍-0.1 / **巫恋"低语"+0.25**（含自身） |
...
| `CC_RECOVER` | 中枢提供的回复速率（恒正） | **F1 求和 + F3 同组取最高（`max_group`）+ 扩散** | 玛恩纳公事公办（room1+扩散15条）/ 维什戴尔巴别塔之帜 / 重岳孤光共照 / 冰酿笑靥如春 / 左膀右臂等 15 条 / 德才兼备等阵营计数 / **夕"不以物喜"**（中枢内全体 +0.05） |
